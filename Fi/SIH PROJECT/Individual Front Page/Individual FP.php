                ...
                <li >
                  ...
                  <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Menu<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                       <li><a href="contributions_u.php" >My Contributions</a></li>
                      
                      <li><a href="../../HOME1/home1.php" >View Events</a></li>
                      <li>
                    <a class="page-scroll" href="../Organisation Front Page/report.php">Search Events</a>
                  </li>
                  <li>
    ...
    <div class="blog-inner area-padding">
      ...
      <div class="container ">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              ...
              <div class="blog-text box1">
                ...
                <marquee behaviour="scroll" SCROLLDELAY=150 direction="up" style="height:380px">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
                <?php include('../Organisation Front Page/graph1.php'); ?>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
               <div class="blog-text box1">
                ...
                <marquee behaviour="scroll" direction="up" style="height:140px" SCROLLDELAY=150 onmouseover="this.stop();" onmouseout="this.start();">
